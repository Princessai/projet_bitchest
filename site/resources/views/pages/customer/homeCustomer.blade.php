  ...
  <div class="row g-0 text-light">
    ...
    <div class=" col-lg-6 col-md-12 col-sm-12">
      <div class="card-body">
        ...
        <a href="https://www.futura-sciences.com/tech/actualites/technologie-elon-musk-investit-15-milliard-dollars-bitcoin-85625/"><button class="shadow__btn">See All</button> </a> 
      </small></p>
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-6 col-md-12 col-sm-12">
      <div class="card-body">
        ...
        <p class="card-text text-light">Dans le monde fascinant et parfois imprévisible des cryptomonnaies, Shiba Inu (SHIB)
           ...
           <p class="card-text"><small >
        <a href="https://fr.investing.com/news/cryptocurrency-news/shiba-inu-shib--cette-ia-avancee-predit-quand-sa-valeur-sera-de-09-et-ce-serait-pour-bientot-2312916" ><button class="shadow__btn">See All</button> </a> 
      </small></p>
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-6 col-md-12 col-sm-12">
      <div class="card-body">
        ...
        <p class="card-text text-light">The token behind Solana, a layer-1 blockchain that’s competitive with the Ethereum blockchain, has been through the wringer after it plummeted from a high of about $260 in late 2021 to a low around $8 in early 2023.
           ...
           <p class="card-text"><small >
        <a href="https://techcrunch.com/2024/03/13/solanas-price-rises-to-160-highest-level-since-january-2022-as-memecoin-mania-rises/" ><button class="shadow__btn">See All</button> </a> 
      </small></p>
      </div>
    </div>
  </div>
