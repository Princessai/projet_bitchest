  ...
  <div class="row">
    ...
    <img src="{{ asset('assets/images/user2.png') }}" class="shadoww__btn" alt="" >
        <div><h3 class="ms-4 text-light">{{Auth::user()->firstname}} {{Auth::user()->lastname}}</h3>
              <h5 class="ms-4 text-light opacity-75">{{Auth::user()->email}}</h5>
      </div>
    ...
    <div class="col-lg-12 mt-5 shadow p-3 mb-5 bg-body rounded">
      ...
      <hr>
      <div class="d-flex justify-content-between"><h5>Firstname</h5><h5 class="me-4">{{Auth::user()->firstname}} </h5></div>
      <hr>
      <div class="d-flex justify-content-between"><h5>Lastname</h5><h5 class="me-4">{{Auth::user()->lastname}}</h5></div>
      <hr>
      <div class="d-flex justify-content-between"><h5>age</h5><h5 class="me-4">{{Auth::user()->age}}</h5></div>
      <hr>
      <div class="d-flex justify-content-between"><h5>Email</h5><h5 class="me-4">{{Auth::user()->email}}</h5></div>
      <hr>
      <div class="d-flex justify-content-between"><h5>Password</h5><h5 class="me-4">{{Auth::user()->password}}</h5></div>
    </div>
  </div>
